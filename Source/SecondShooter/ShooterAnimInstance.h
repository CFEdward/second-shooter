 ...
 */
UCLASS()
class SECONDSHOOTER_API UShooterAnimInstance : public UAnimInstance
{
	GENERATED_BODY()
...
private:
	...
	/** True when reloading, used to prevent Aim Offset while aiming */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Turn In Place", meta = (AllowPrivateAccess = "true"))
	bool bReloading;
	...
	/** True when not realoading or equipping */
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Combat", meta = (AllowPrivateAccess = "true"))
